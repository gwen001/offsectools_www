...
export default {
    ...
    head: {
        ...
        meta: [
            ...
            { name: 'description', content: process.env.APP_DESCR },
            ...
            { property: 'og:description', content: process.env.APP_DESCR },
            { property: 'og:type', content: 'website' },
            { property: 'og:image', content: process.env.APP_URL+'/img/preview.png' },
            { name: 'twitter:card', content: 'summary_large_image' },
            { name: 'twitter:site', content: '@gwendallecoguic' },
            { name: 'twitter:creator', content: '@gwendallecoguic' },
            { name: 'twitter:description', content: process.env.APP_DESCR },
            { name: 'twitter:title', content: process.env.APP_TITLE },
            { name: 'twitter:image', content: process.env.APP_URL+'/img/preview.png' },
        ],
        link: [
    ...
    redirect: {
        rules: (process.env.APP_ENV!='prod') ? [
            ...
            { from: '^/tag/last7days$', to: process.env.APP_URL+'/last7days', statusCode: 301 }
        ]
    },
