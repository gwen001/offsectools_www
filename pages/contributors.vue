<template>
    <div id="contributors" class="container h-100 p-3">
        <div class="row">
...
export default {
    ...
    computed: {
        contributors() {
            return this.$store.getters['getContributors'];
        }
    },
    mounted() {
        document.getElementById('main-content').scrollTo(0,0);
        this.$store.commit( 'resetSearch', 1 );
        this.$store.commit( 'setAwesomeBackground', [this.$config.ASSETS_URL+'/background/contributors.jpg','rez0','https://twitter.com/rez0__'] );
    }
}
</script>
